...
<body>
        ...
        <div class="container">
          <div class="contact_nav">
            <a href="">
              ...
              <span>
                Address :No 108,Don Bosco Nagar,<br>Opp.Don Bosco Matriculation School,Tirupattur-635601.
              </span>
            </a>
            <a href="">
              <i class="fa fa-envelope" aria-hidden="true"></i>
              <span>
                Email : happylearningskillssolutions@gmail.com
              </span>
            </a>
            <a href="">
              <i class="fa fa-phone" aria-hidden="true"></i>
              <span>
                Phone Call : +91 8148333603
              </span>
            </a>
          </div>
        </div>
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container">
          ...
          <div id="myNav" class="overlay">
            ...
            <div class="overlay-content">
              ...
              <a class="" href="about.html"> About HLS</a>
          ...
          <a class="navbar-brand" href="index.html">
            <span>
              <p color="orange">HLS SOLUTIONS</p>
            </span>
          </a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="box">
            <div class="img-box">
                <img src="images/service12.gif" alt="" />
            </div>
            <div class="detail-box">
              ...
              <p>
                We are developing application, automation tool, web designing, etc. as per your business requirement.				
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="box ">
            <div class="img-box">
                <img src="images/service22.gif" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Students Project
              ...
              <p>
                We are guiding students to innovate a new projects to explore their knowledge. 
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="box">
            <div class="img-box">
                <img src="images/service33.gif" alt="" />
            </div>
            <div class="detail-box">
              <h5>
                Trainings On
              ...
              <p>
                Open Source Software, OOPs Concept, Data Structure, Algorithms, Web Development, Basics in Computer, Computer Programming, C, C++, Java, Python, Office Tools etc.
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6">
          <div class="box">
            <div class="img-box">
                <img src="images/service44.gif." alt="" />
            </div>
            <div class="detail-box">
                <h5>
                Soft Skill Training
                ...
                <p>
                Spoken English,Interview Skills etc.
              </p>
            </div>
          </div>
        </div>
  ...
  <section class="about_section layout_padding">
    <div class="container-fluid">
      <div class="box">
        <div class="img-box">
            <img src="images/study3.PNG" alt="" />
        </div>
        <div class="detail-box">
          <h2>
            About Us
          </h2>
          <p>Happy Learning Skills Training Institute provides professional technology knowledge and spoken English coaching training in order to prepare skilled and knowledgable individuals for betterment to get adopt with current technological world. We are having good enugh to each and guide students to develope their logical skill in technology and their personality in skill training.
          </p>
          <a href="">
            <span>
              Read More
  ...
  <section class="wehave_section">
    <div class="container-fluid">
      <div class="box">
        ...
        <div class="img-box">
            <img src="images/teachin1.jpg" alt="" />
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="why_container">
        <div class="box">
          ...
          <div class="detail-box">
            <h5>
              We are providing excellent training
            </h5>
            <a href="">
              <span>
                Read More
          ...
          <div class="info_contact">
            ...
            <div class="contact_link_box">
              ...
              <a href="">
                <i class="fa fa-envelope" aria-hidden="true"></i>
                <span>
                  happylearningskillssolutions@gmail.com
                </span>
              </a>
            </div>
          </div>
  ...
  <footer class="footer_section container-fluid">
    <p>
      <a href="https://html.hlssolutions.org/">Visit Our Website</a>
    </p>
  </footer>
  <!-- footer section -->
